...
const Pricing = () => {
  return (
    <div className=" mx-10   px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
      <div className="mx-auto max-w-3xl text-center">
        <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">
          Flexible Pricing
        </h2>
      </div>
      <div className="grid grid-cols-1 gap-4 mt-10 sm:grid-cols-2 sm:items-stretch md:grid-cols-3 md:gap-8">
